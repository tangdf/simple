...
<!--  <fieldset id="fd2">
        ...
        <div id="form1">
          ...
          <colgroup align="left" width="13%"></colgroup>
           ...
           <div id="datagrid1" class="mini-datagrid" style="width:100%;height:390px; margin-top: 5px" 
             url="<%=request.getContextPath()%>/work/f20010101/queryYlbxInfo.action"  allowResize="true">
		        <div property="columns">
		        <div field="lsh" width="70" height="20" headerAlign="center" align="center" >流水号</div>
		        <div field="name" width="100" height="20" headerAlign="center" align="center" >受理信息</div> 
		        <div field="status" width="100" height="20" headerAlign="center" align="center" >审核状态</div> 
		         <div field="memo" width="100" height="20" headerAlign="center" align="center" >审核意见</div> 
		    	</div>
			</div> 
