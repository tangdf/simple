...
<form action="#" enctype="multipart/form-data" method="post" target="upload-result" id="uploadForm" name="uploadForm">
    <fieldset id="fd3">
        ...
        <div class="fieldset-body">
        	...
        	医院等级 : 
        	<input id="data25" name="data25" class="mini-combobox" style="width:100px;" textField="text" valueField="id" emptyText="请选择..."
				       data="[{id:'1',text:'一级'},{id:'2',text:'二级'},{id:'3',text:'三级'},{id:'4',text:'社区'}]"  allowInput="true" showNullItem="true" nullItemText="请选择..."/> 
        	
        	</div>
            <div id="div1">
             <font color="red">注:医院等级证书或相应等级批准文件以照片形式上传</font></br>
...
function search() {
			mini.open({
			    ...
			    title: "医院等级证书或相应等级批准文件附件", width: 1000, height: 600,
			    onload: function () {
...
function saveData(){
		...
		var options  = {    
		url:'<%=request.getContextPath() %>/work/f20010106/saveYydjInfo.action?data25='+data25,   
			type:'post',    
