...
<body>
           <div id="datagrid1" class="mini-datagrid" style="width:100%;height:360px;" 
             url="<%=request.getContextPath()%>/work/f10010702/loadBornMedicalFee.action"  idField="aac003" allowResize="true" 
             >
		    <div property="columns">
		        <div type="indexcolumn" ></div>
		        <div field="caa121" width="100" headerAlign="center" align="center" >费用类型</div>  
		        ...
		        <div field="aae003" width="100" headerAlign="center" align="center">对应年月</div> 
...
//加载数据
 ...
 //数据合计
 //var url = '<%=request.getContextPath()%>/work/f10010702/loadSumBornMedicalFee.action';
