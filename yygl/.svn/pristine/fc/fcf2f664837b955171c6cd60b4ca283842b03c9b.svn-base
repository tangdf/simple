...
<form action="#" enctype="multipart/form-data" method="post" target="upload-result" id="uploadForm" name="uploadForm">
    <fieldset id="fd3">
        ...
        <div class="fieldset-body">
            ...
            <div id="div1">
             <font color="red">注:缴纳社会保险费票据、参保人员花名册复印件以照片形式上传</font></br>
...
//加载数据
 var url = '<%=request.getContextPath()%>/work/f20010114/queryShbxInfo.action';
...
function search() {
			mini.open({
			    ...
			    title: "缴纳社会保险费票据、参保人员花名册附件", width: 1000, height: 600,
			    onload: function () {
...
function saveData(){
		...
		var options  = {    
		url:'<%=request.getContextPath() %>/work/f20010114/saveShbxInfo.action',   
			type:'post',    
