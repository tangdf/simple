 ...
 */
@Controller
@RequestMapping(value="/work/f10020105/")
public class F10020105Action {
	...
	public String index(){
		return "/f10/f1002/f100201/f10020105/index";
	}
	@RequestMapping("queryTreatDetailInfo.action")
	@ResponseBody
	public String queryTreatDetailInfo(HttpServletRequest request){
		...
		jmylService.queryTreatDetailInfo(page, aac001);
