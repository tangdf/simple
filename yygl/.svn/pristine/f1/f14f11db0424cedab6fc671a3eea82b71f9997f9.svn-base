...
<form action="#" enctype="multipart/form-data" method="post" target="upload-result" id="uploadForm" name="uploadForm">
    <fieldset id="fd3">
        ...
        <div class="fieldset-body">
            ...
            <div id="div1">
             <font color="red">注:配备药品目录清单（基本医疗保险目录内药品加标注）以照片形式上传</font></br>
...
//加载数据
 var url = '<%=request.getContextPath()%>/work/f20010113/queryYpmlInfo.action';
...
function search() {
			mini.open({
			    ...
			    title: "配备药品目录清单附件", width: 1000, height: 600,
			    onload: function () {
...
function saveData(){
		...
		var options  = {    
		url:'<%=request.getContextPath() %>/work/f20010113/saveYpmlInfo.action',   
			type:'post',    
