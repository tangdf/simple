...
<body>
           <div id="datagrid1" class="mini-datagrid" style="width:100%;height:360px;" 
             url="<%=request.getContextPath()%>/work/f10010503/loadPensionDetails.action"  idField="aac003" allowResize="true" 
             >
		    <div property="columns">
		        <div type="indexcolumn" ></div>
		        <div field="aac003" width="100" headerAlign="center" align="center">姓名</div>    
		        <div field="aae002" width="100" headerAlign="center" align="center">发放日期</div>                             
...
//加载数据
 ...
 //数据合计
 var url = '<%=request.getContextPath()%>/work/f10010503/loadSumPensionDetails.action';
