...
<head>
	...
	<title>医疗服务场所产权或租赁合同/租赁凭证</title>
...
<form action="#" enctype="multipart/form-data" method="post" target="upload-result" id="uploadForm" name="uploadForm">
    <fieldset id="fd3">
        ...
        <div class="fieldset-body">
        	...
        	建筑面积（平方米） : 
        	<input id="data25" name="data25" class="mini-textbox" style="width:160px;"  vtype="maxLength:50"    /> 
        	</div>
            <div id="div1">
             <font color="red">注:医疗服务场所产权或租赁合同/租赁凭证（建筑面积）复印件以照片形式上传</font></br>
...
function saveData(){
		...
		var options  = {    
		url:'<%=request.getContextPath() %>/work/f20010107/saveYlfwInfo.action?data25='+data25,   
			type:'post',    
