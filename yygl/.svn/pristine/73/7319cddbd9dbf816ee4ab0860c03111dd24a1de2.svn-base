...
import com.wb.utils.web.RequestUtils;
	 ...
	 */
	@Controller
	@RequestMapping(value="/public/f10030112/")
	public class F10030112Action {
		...
		public String index(){
			return "/f10/f1003/f100301/f10030112/index";
		}
		@RequestMapping("queryZlxmfwsscx.action")
		@ResponseBody
		public String queryZlxmfwsscx(HttpServletRequest request,String cxtj1,String cxtj2,String cxtj3 ){
			...
			fastQueryService.queryZlxmfwsscx(page, cxtj1,cxtj2);
