 ...
 */
@Controller
@RequestMapping(value="/work/f10010401/")
public class F10010401Action {
	@Autowired
	private EmpService empService;
	
	@RequestMapping("index.action")
	public String index(){
			return "/f10/f1001/f100104/f10010401/index";
	}
	@RequestMapping("loadMedicalApproval.action")
	@ResponseBody
	public String loadMedicalApproval(HttpServletRequest request){
		...
		empService.queryMedicalApproval(page, aac001);
