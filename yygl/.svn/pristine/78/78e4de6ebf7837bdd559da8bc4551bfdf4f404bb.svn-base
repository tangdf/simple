...
<body>
    ...
    <form method="post" enctype="multipart/form-data" name="uploadForm" id="uploadForm" 
		action="<%=request.getContextPath()%>/work/f20010110/importHl.action" target="hidden_frame">  
		<table>  
		 <tr> 
			<td>上传文件: </td>  
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:780px;height:280px;" 
        url="<%=request.getContextPath()%>/work/f20010110/queryHlInfo.action"  allowResize="true"allowResize="true" 
    ...
    <div title="导入失败信息">
        ...
        url="<%=request.getContextPath()%>/work/f20010110/queryErrInfo.action"  allowResize="true"allowResize="true" 
        allowCellEdit="true" allowCellSelect="true" multiSelect="true" 
 ...
 $(".mini-button").ajaxStart(function(){
        ...
        function addData() {          
            mini.open({
			    url: '<%=request.getContextPath()%>/pages/f20/f2001/f200101/f20010110/addhl.jsp',
        ...
        function editData() {  
            ...
            if (rows.length !=1) {
            	...
            	mini.open({
				    url: '<%=request.getContextPath()%>/pages/f20/f2001/f200101/f20010110/edithl.jsp',
				    title: "编辑护理人员信息", width: 700, height: 420,
				    onload: function () {
				        var iframe = this.getIFrameEl();
        ...
        function queryFj(dataid){
        	mini.open({
			    ...
			    title: "护理人员附件", width: 1000, height: 600,
			    onload: function () {
			        var iframe = this.getIFrameEl();
		             //var dataid = record.dataid;
			        var data = {lsh:dataid};
	                ...
	                if(confirm("确定要删除数据吗？"))
					 {
			            ...
			            if(json!=null&&json!='[]'){
			            	$.ajax({
				                url: "<%=request.getContextPath() %>/work/f20010110/deleteDataListInfo.action",
				                data: { dataJson: json},
				                type: "post",
        ...
        function saveData() {            
            ...
            if(json!=null&&json!='[]'){
            	$.ajax({
	                url: "<%=request.getContextPath() %>/work/f20010110/saveDataListInfo.action",
        ...
        function checkData(){  
    		...
    		var options  = {  
    			url:'${pageContext.servletContext.contextPath}/work/f20010110/importHl.action',  
    			type:'post',  
