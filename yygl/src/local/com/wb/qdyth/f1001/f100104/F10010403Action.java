 ...
 */
@Controller
@RequestMapping(value="/work/f10010403/")
public class F10010403Action {
	@Autowired
	private EmpService empService;
	
	@RequestMapping("index.action")
	public String index(){
		return "/f10/f1001/f100104/f10010403/index";
	}
	@RequestMapping("loadMedicalAnnualInfo.action")
	@ResponseBody
	public String loadMedicalAnnualInfo(HttpServletRequest request){
		...
		empService.queryMedicalAnnualInfo(page, aac001);
