...
public class F10010304Action {
	...
	public String index(){
		return "f10/f1001/f100103/f10010304/index";
	}
	@RequestMapping("loadUnemploymentPay.action")
	@ResponseBody
	public String loadUnemploymentPay(HttpServletRequest request){
		...
		empService.queryUnemploymentPay(page, aac001);
