 ...
 */
@Controller
@RequestMapping(value="/work/f10010701/")
public class F10010701Action {
	@Autowired
	private EmpService empService;
	
	@RequestMapping("index.action")
	public String index(){
		return "/f10/f1001/f100107/f10010701/index";
	}
	@RequestMapping("loadBornTreatment.action")
	@ResponseBody
	public String loadBornTreatment(HttpServletRequest request){
		...
		empService.queryBornTreatment(page, aac001);
		return JsonUtils.getJsonByPage(page);
	}
	@RequestMapping("loadSumBornTreatment.action")
	@ResponseBody
	public String loadSumBornTreatment(HttpServletRequest request){
		HttpSession session=request.getSession();
		String aac001=(String)session.getAttribute(SessionUtils.USERKEY);
		BornInfoVO vo=empService.querySumBornTreatment(aac001);
