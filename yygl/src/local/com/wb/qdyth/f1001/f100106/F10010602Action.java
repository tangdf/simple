 ...
 */
@Controller
@RequestMapping(value="/work/f10010602/")
public class F10010602Action {
	@Autowired
	private EmpService empService;
	
	@RequestMapping("index.action")
	public String index(){
		return "/f10/f1001/f100106/f10010602/index";
	}
	@RequestMapping("loadWorkInjuryTreatment2.action")
	@ResponseBody
	public String loadWorkInjuryTreatment2(HttpServletRequest request){
		...
		empService.queryWorkInjuryTreatment2(page, aac001);
		return JsonUtils.getJsonByPage(page);
	}
	@RequestMapping("loadSumWorkInjuryTreatment2.action")
	@ResponseBody
	public String loadSumWorkInjuryTreatment2(HttpServletRequest request){
		HttpSession session=request.getSession();
		String aac001=(String)session.getAttribute(SessionUtils.USERKEY);
		WorkInjuryVO vo=empService.querySumWorkInjury2(aac001);
