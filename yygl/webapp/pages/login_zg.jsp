...
<div class="login_title">
 ...
 <form name="loginForm" action="<%=request.getContextPath()%>/login.action" method="post" onsubmit="return validate(this);">
  ...
  <div class="login_test"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本查询可以为公众提供社保 个人账户综合信息、参保信息 、基数信息、养老缴费情况、养老待遇、养老金支付、失业保险、
    医疗保险、社保卡消费明细等的信息查询,
     用户输入身份证号码和社保编号进行查询。</span> 
    <br />
<span>说明：</span><br />
首次登陆初始密码为老卡的个人编号（磁条）或新卡的社会保障卡号（芯片）。 
<br />
