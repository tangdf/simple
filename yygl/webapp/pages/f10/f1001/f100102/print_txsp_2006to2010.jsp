...
<script type="text/javascript">
  ...
  <table width="90%"  align="center" cellpadding="3" style="border-color: black ;border-collapse: collapse;font-size:12px">
  <COLGROUP>
		...
		<COL width='16%' align="center">
	    		...
	    		<table  width="90%"  bgcolor="black">
	    			...
	    			<tr height="23">
	    				<td nowrap="nowrap" align="center" bgcolor="white" colspan="8"><font size="2">一、按原办法计发养老金(鲁政发[1997]109号)</font></td>
	    			</tr>
	    			<tr height="23">
	    			...
	    			<tr height="23">
	    				<td align="center" bgcolor="white"><font size="2">过渡性补贴</font></td>
	    				<td align="left" bgcolor="white" colspan="7"><font size="2">
	    					${vo.data34}&nbsp;元
	    				</font></td>
	    			</tr>
	    			...
	    			<tr height="23">
	    				<td nowrap="nowrap" align="center" bgcolor="white" colspan="8"><font size="2">二、按（鲁政发[2006]92号）计发养老保险待遇</font></td>
	    			</tr>
	    			<tr height="23">
	    				<td align="center" bgcolor="white"><font size="2">基础养老金</font></td>
	    				<td align="left" bgcolor="white" colspan="7"><font size="2">
	    			...
	    			<tr height="23">
	    				<td width="10%" align="center" bgcolor="white"><font size="2">过渡性调节金</font></td>
	    				<td width="20%" align="left" bgcolor="white" colspan="7"><font size="2">
	    					（120元&nbsp;&nbsp;＋&nbsp;&nbsp;
	    					${vo.data32}&nbsp;&nbsp;元&nbsp;&nbsp;(工龄补贴)&nbsp;&nbsp;）
	    					&nbsp;&nbsp;×&nbsp;&nbsp;${vo.data59}%&nbsp;&nbsp;=&nbsp;&nbsp;${vo.data60}&nbsp;&nbsp;元
	    				</font></td>
	    			</tr>
	    			<tr height="23">
	    				<td align="center" bgcolor="white"><font size="2">养老金总额②</font></td>
 ...
 说明 ：1、计算过渡性养老金的缴费年限是指建立个人账户前缴费年限。
	   2、过渡性调节金中：120元加工龄补贴的合计最多不超过150元。
	   3、病退和破产企业提前退休人员按原办法计算基本养老金的计算公式：
基本养老金=（基础养老金+过渡性养老金+过渡性调节金）×（1-提前退休年限×2%）+个人账户养老金   
	   4、只有退休年月为2007年1月1日至2010年12月31日的职工有过渡性补贴
	        过渡性补贴的计算公式 = (基础养老金+过渡性养老金) × 5%
	   				</font></td>
	    			</tr>
			</table>
