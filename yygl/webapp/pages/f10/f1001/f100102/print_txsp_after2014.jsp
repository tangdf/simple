...
<script type="text/javascript">
	...
	function create() {
	    ...
	    LODOP.ADD_PRINT_HTM('1cm','1.5cm','18cm','27.7cm', document.getElementById("from_div").innerHTML);
	}
  ...
  <table width="90%"   cellpadding="3" style="border-color: black ;border-collapse: collapse;font-size:12px">
				...
				<tr >
	    			...
	    			<td width="30%"  align="center" bgcolor="white" style="word-break:break-all; word-wrap:break-word;"><font size="2">${vo.data02}</font></td>
	    		...
	    		<table  width="90%"  bgcolor="black">
	    			<tr height="23">
	    				<td  align="center" bgcolor="white"><font size="2">职工编号</font></td>
	    				<td  align="center" bgcolor="white"><font size="2">${vo.aae001}</font></td>
	    				<td  align="center" bgcolor="white" colspan="2"><font size="2">公民身份证号码</font></td>
	    				<td  align="center" bgcolor="white" colspan="2"><font size="2">${vo.data05}</font></td>
	    				<td  align="center" bgcolor="white"><font size="2">离退休类别</font></td>
	    				<td  bgcolor="white" align="center"><font size="2">${vo.data06}</font></td>
	    			</tr>
	    			<tr height="23">
	    				<td  align="center" bgcolor="white"><font size="2">姓&nbsp;名</font></td>
	    				<td bgcolor="white" align="center" width="50"><font size="2">${vo.data07}</font></td>
	    				<td  align="center" bgcolor="white"><font size="2">性&nbsp;别</font></td>
	    				<td bgcolor="white" align="center" width="50"><font size="2">${vo.data08}</font></td>
	    				<td  align="center" bgcolor="white"><font size="2">民&nbsp;族</font></td>
	    				<td bgcolor="white" align="center"><font size="2">${vo.data09}</font></td>
	    				<td  align="center" bgcolor="white"><font size="2">出生日期</font></td>
	    			...
	    			<tr height="23">
	    				<td align="center" bgcolor="white" colspan="2"><font size="2">参加工作时间</font></td>
	    				<td align="center" bgcolor="white" colspan="2"><font size="2">${vo.data15}</font></td>
	    				<td align="center" bgcolor="white" colspan="2"><font size="2">档案出生时间</font></td>
	    				<td align="center" bgcolor="white" colspan="2"><font size="2">${vo.data17}</font></td>
	    			</tr>
	    			<tr height="23">
	    			...
	    			<tr height="23">
	    				...
	    				<td align="left" bgcolor="white" colspan="7"><font size="2">基础养老金&nbsp;&nbsp;&nbsp;+&nbsp;&nbsp;&nbsp;个人账户养老金&nbsp;&nbsp;&nbsp;+&nbsp;&nbsp;&nbsp;过渡性养老金&nbsp;&nbsp;&nbsp;
	    				&nbsp;&nbsp;&nbsp;=&nbsp;&nbsp;&nbsp;${vo.data45}元</font></td>
	    			</tr>
