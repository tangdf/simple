...
<body>
           <div id="datagrid1" class="mini-datagrid" style="width:100%;height:360px;" 
             url="<%=request.getContextPath()%>/work/f10010502/loadRetirementBenifits.action"  idField="aac003" allowResize="true" 
             >
...
//加载数据
 ...
 //数据合计
 var url = '<%=request.getContextPath()%>/work/f10010502/loadSumTreatment.action';
