...
<head>
	...
	<title>国家、省、市组织人事部门认可的专业学术称号专家（第一执业地点为申请医药机构）证明材料复印件</title>
...
<form action="#" enctype="multipart/form-data" method="post" target="upload-result" id="uploadForm" name="uploadForm">
    <fieldset id="fd3">
        ...
        <div class="fieldset-body">
            ...
            <div id="div1">
             <font color="red">注:国家、省、市组织人事部门认可的专业学术称号专家（第一执业地点为申请医药机构）证明材料复印件以照片形式上传</font></br>
...
//加载数据
 var url = '<%=request.getContextPath()%>/work/f20010116/queryZjzmInfo.action';
...
function search() {
			mini.open({
			    ...
			    title: "专家证明材料附件", width: 1000, height: 600,
			    onload: function () {
...
function saveData(){
		...
		var options  = {    
		url:'<%=request.getContextPath() %>/work/f20010116/saveZjzmInfo.action',   
			type:'post',    
