...
<form action="#" enctype="multipart/form-data" method="post" target="upload-result" id="uploadForm" name="uploadForm">
    <fieldset id="fd3">
        ...
        <div class="fieldset-body">
            ...
            <div id="div1">
             <font color="red">注:程序及系统开发清单（包括系统开发商名称、使用时间、接口类型），与开发商签订的服务协议复印件以照片形式上传</font></br>
...
//加载数据
 var url = '<%=request.getContextPath()%>/work/f20010112/queryCxxtInfo.action';
...
function search() {
			mini.open({
			    ...
			    title: "程序及系统开发清单", width: 1000, height: 600,
			    onload: function () {
...
function saveData(){
		...
		var options  = {    
		url:'<%=request.getContextPath() %>/work/f20010112/saveCxxtInfo.action',   
			type:'post',    
