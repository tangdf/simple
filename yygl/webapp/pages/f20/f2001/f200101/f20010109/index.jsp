...
<body>
        ...
        <div id="form1">
          ...
          <colgroup align="left" width="13%"></colgroup>
                <tr>
                    ...
                    <td>
                       <input id="data01" name="data01" class="mini-textbox" style="width:150px;"  vtype="maxLength:50"  /> 
                    </td>
                    ...
                    <td>
                          <input id="data02" name="data02" class="mini-textbox" style="width:150px;" vtype="maxLength:50" /> 
                    </td>
                      <td>
    ...
    <form method="post" enctype="multipart/form-data" name="uploadForm" id="uploadForm" 
		action="<%=request.getContextPath()%>/work/f20010109/importYj.action" target="hidden_frame">  
		<table>  
		 <tr> 
			<td>上传文件: </td>  
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:780px;height:280px;" 
        url="<%=request.getContextPath()%>/work/f20010109/queryYjInfo.action"  allowResize="true"allowResize="true" 
        ...
        <div property="columns">
		    ...
		    <div field="data05" width="150" headerAlign="center" align="center" >资格证号</div>   
		    ...
		    <div field="data11" width="200" headerAlign="center" align="center" >备注</div> 
		    <div field="clzt" width="200" headerAlign="center" align="center" visible="false" >处理状态</div>
		    <div field="data58" width="200" headerAlign="center" align="center" >人员重复情况</div>        
		    <div field="data52" width="1" headerAlign="center" align="center" visible="true"  >重复标志</div>            
        </div>
    </div>
    </div>
    <div title="导入失败信息">
        <div id="datagrid2" class="mini-datagrid" style="width:780px;height:280px;" 
        url="<%=request.getContextPath()%>/work/f20010109/queryErrInfo.action"  allowResize="true"allowResize="true" 
        allowCellEdit="true" allowCellSelect="true" multiSelect="true" 
 ...
 $(".mini-button").ajaxStart(function(){
        ...
        function addData() {          
            mini.open({
			    url: '<%=request.getContextPath()%>/pages/f20/f2001/f200101/f20010109/addyj.jsp',
			    title: "新增医技人员信息", width: 700, height: 420,
			    onload: function () {
        ...
        function editData() {  
            ...
            if (rows.length !=1) {
            	...
            	mini.open({
				    url: '<%=request.getContextPath()%>/pages/f20/f2001/f200101/f20010109/edityj.jsp',
				    title: "编辑医技人员信息", width: 700, height: 420,
				    onload: function () {
				        var iframe = this.getIFrameEl();
        ...
        function queryFj(dataid){
        	mini.open({
			    ...
			    title: "医技人员附件", width: 1000, height: 600,
			    onload: function () {
			        var iframe = this.getIFrameEl();
		             //var dataid = record.dataid;
			        var data = {lsh:dataid};
	                ...
	                if(confirm("确定要删除数据吗？"))
					 {
			            ...
			            if(json!=null&&json!='[]'){
			            	$.ajax({
				                url: "<%=request.getContextPath() %>/work/f20010109/deleteDataListInfo.action",
				                data: { dataJson: json},
				                type: "post",
        ...
        function saveData() {            
            ...
            if(json!=null&&json!='[]'){
            	$.ajax({
	                url: "<%=request.getContextPath() %>/work/f20010109/saveDataListInfo.action",
        ...
        function checkData(){  
    		...
    		var options  = {  
    			url:'${pageContext.servletContext.contextPath}/work/f20010109/importYj.action',  
    			type:'post',  
		...
		function exportError(){
			...
			window.location.href="${pageContext.servletContext.contextPath}/work/f20010108/exportYs.action?pc="+pc+"&lx=200109";
		}
    </script>
</body>
</html>
