...
<form action="#" enctype="multipart/form-data" method="post" target="upload-result" id="uploadForm" name="uploadForm">
    <fieldset id="fd3">
        ...
        <div class="fieldset-body">
            ...
            <div id="div1">
             <font color="red">注:《药品使用质量管理规范确认书》正、副本复印件以照片形式上传</font></br>
...
//加载数据
 var url = '<%=request.getContextPath()%>/work/f20010104/queryYpzlgfrzInfo.action';
...
function search() {
			mini.open({
			    ...
			    title: "药品使用质量管理规范确认书", width: 1000, height: 600,
			    onload: function () {
...
function saveData(){
		...
		var options  = {    
		url:'<%=request.getContextPath() %>/work/f20010104/saveYpzlgfrzInfo.action',   
			type:'post',    
